...
![Интерфейс программы](./.github/promo.png)
---
...
![Excel-табличка. Посещение по дням](./.github/promo_excel_matrix.png)

**Сводка** — статистика по каждому участнику за весь период.

![Excel-табличка. Сводная таблица](./.github/promo_excel_aggregate.png)
